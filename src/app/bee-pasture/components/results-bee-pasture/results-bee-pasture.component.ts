...
import { ADD_BEE_PASTURE_HEADER, BEE_PASTURE_FORM,EDIT_BEE_PASTURE_HEADER,FILTERS_FARM, RESULT_BEE_PASTURE_HEADER } from "src/app/mock_data/bee-pasture";
import { ADD_FARM_FOREST_HEADER, EDIT_FARM_FOREST_HEADER, FARM_FOREST_FORM } from "src/app/mock_data/farm-forest-tree";
...
@Component({
  selector: 'app-results-bee-pasture',
  templateUrl: './results-bee-pasture.component.html',
  styleUrls: ['./results-bee-pasture.component.scss']
})
export class ResultsBeePastureComponent implements OnInit {
...
public filterValue:string='total'
  ...
  ngOnInit(): void {
    this.headerItems = RESULT_BEE_PASTURE_HEADER;
