...
import { ADD_BEE_PASTURE_TABLE_DATA, RESULTS_BEE_PASTURE_TOTAL_TABLE_DATA } from "src/app/mock_data/bee-pasture";
...
export class ResultsBeePastureTotalTableService {
    
  private data: AddBeePastureTableModel[] = RESULTS_BEE_PASTURE_TOTAL_TABLE_DATA;
