...
import { ADD_FARM_FOREST_HEADER, EDIT_FARM_FOREST_HEADER, FARM_FOREST_FORM,FILTERS_FARM } from "src/app/mock_data/farm-forest-tree";
...
@Component({
  selector: 'app-farm-forest-tree-type',
  templateUrl: './farm-forest-tree-type.component.html',
  styleUrls: ['./farm-forest-tree-type.component.scss']
})
export class FarmForestTreeTypeComponent implements OnInit {
